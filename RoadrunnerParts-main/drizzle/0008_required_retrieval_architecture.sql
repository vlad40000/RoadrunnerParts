...
ALTER TABLE retrieval_jobs ADD COLUMN IF NOT EXISTS bom_job_id text;
ALTER TABLE retrieval_jobs ADD COLUMN IF NOT EXISTS source_url_id uuid REFERENCES model_source_urls(id) ON DELETE SET NULL;
ALTER TABLE retrieval_jobs ADD COLUMN IF NOT EXISTS result_summary jsonb NOT NULL DEFAULT '{}'::jsonb;
ALTER TABLE retrieval_jobs ADD COLUMN IF NOT EXISTS updated_at timestamptz NOT NULL DEFAULT now();
