 ...
 */
/**
 * BOM Status - Final outcomes for a BOM result
 */
...
/**
 * Retrieval State - Granular pipeline states for the retrieval worker
 */
...
/**
 * Extracted Identity - The "Visual Truth" from OCR/Text
 */
export const extractedIdentitySchema = z.object({
  raw_brand: z.string().nullable(),
  raw_model: z.string().nullable(),
  raw_serial: z.string().nullable(),
  raw_product_type: z.string().nullable(),
...
/**
 * Model Identity - Normalized and validated appliance information
 */
...
export type RawExtractedIdentity = z.infer<typeof extractedIdentitySchema>;
...
// DEPRECATED: Transitioning to ModelIdentity
export const identitySchema = z.object({
  brand: z.string().nullable(),
  normalized_model: z.string().nullable(),
  serial: z.string().nullable(),
  product_type: z.string().nullable(),
...
export type NormalizedIdentity = ModelIdentity;
