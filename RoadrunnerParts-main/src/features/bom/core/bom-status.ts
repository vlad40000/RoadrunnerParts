...
> = {
  ...
  summary_only: {
    label: "summary only",
    description: "Only summary source evidence is available so far.",
    tone: "neutral",
  },
  diagram_parsed: {
  ...
  pricing_partial: {
    ...
    description: "Accepted rows exist, but some exact retail pricing is still missing.",
    tone: "amber",
  },
  synthesis_complete: {
  ...
  retrieval_pending: {
    ...
    description: "A background retrieval job has been queued.",
    tone: "neutral",
  },
  cache_hit: {
    label: "cache hit",
    description: "The result was restored from the verified model cache.",
    tone: "green",
  },
  needs_fallback: {
  ...
  blocked: {
    label: "blocked",
    description: "The source blocked retrieval. Upload manual evidence or retry later at a lower rate.",
    tone: "amber",
  },
  failed: {
    label: "failed",
